...
@section('content')
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container my-6 px-6 mx-auto grid">
            ...
            <form action="{{ route('admin.clients.update', $client->id) }}" method="POST" class="flex flex-col bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="flex gap-4">
                    ...
                    <div class="flex flex-col w-full gap-4">
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text" name="name" value="{{ old('name', $client->name) }}" required class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="email" name="email" value="{{ old('email', $client->email) }}" required class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700
                              focus:border-purple-400 focus:outline-none focus:shadow-outline-purple
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="tel" name="phone" value="{{ old('phone', $client->phone) }}" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700
                              focus:border-purple-400 focus:outline-none focus:shadow-outline-purple
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text" name="passport" value="{{ old('passport', $client->passport) }}" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700
                              focus:border-purple-400 focus:outline-none focus:shadow-outline-purple
                    ...
                    <div class="flex flex-col w-full gap-4">
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="date" name="birthday" value="{{ old('birthday', $client->birthday) }}" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700
                              focus:border-purple-400 focus:outline-none focus:shadow-outline-purple
