...
@section('content')
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container my-6 px-6 mx-auto grid">
            ...
            <form action="{{ route('admin.countries.update', $country->id) }}" method="POST" class="w-full bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="flex flex-col items-center justify-center gap-4 md:flex-row md:space-x-2 mb-4">
                    <div class="w-full md:w-1/2">
                        ...
                        <input type="text" name="name" id="name" class="mt-1 block w-full form-input text-gray-700 dark:text-gray-300 dark:bg-gray-700 rounded-md border-gray-300 dark:border-gray-600 focus:border-purple-500 focus:ring focus:ring-purple-200" value="{{ old('name', $country->name) }}" placeholder="Enter country name">
                    </div>
                </div>

                <div class="flex justify-end items-center space-x-4">
                    <a href="{{ route('admin.countries.index') }}" class="text-sm text-gray-600 dark:text-gray-400 hover:underline">
                        Back
                    </a>
