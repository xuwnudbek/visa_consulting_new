        ...
        <div class="container grid px-6 mx-auto my-6">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between my-6 w-full gap-4">
                ...
                <div class="flex items-center w-full sm:w-auto gap-2 flex-col sm:flex-row">
                    ...
                    <a href="{{ route('admin.applications.create') }}" class="flex w-full sm:w-auto justify-center items-center px-4 py-2 bg-purple-600 text-white text-sm font-medium rounded-md shadow hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-purple-500">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.import') }}" class="flex w-full sm:w-auto justify-center items-center px-4 py-2 bg-purple-600 text-white text-sm font-medium rounded-md shadow hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                        </svg>
                            ...
                            @foreach ($applications as $index => $application)
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3 flex justify-center gap-1">
                                        <a href="{{ route('admin.applications.show', $application) }}" class="flex items-center text-blue-600 hover:underline mr-2">
                                            Show
                                        </a>
                                        <a href="{{ route('admin.applications.edit', $application) }}" class="flex items-center text-purple-600 hover:underline mr-2">
                                            Edit
                                        </a>
