<?php $__env->startSection('title', 'Edit Field'); ?>
...
<?php $__env->startSection('content'); ?>
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container my-6 px-6 mx-auto grid">
            ...
            <form action="<?php echo e(route('admin.fields.update', $field->id)); ?>" method="POST" enctype="multipart/form-data" class="w-full bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="flex flex-col items-start justify-center gap-4 sm:flex-row sm:space-x-1 mb-4">
                    <div class="flex flex-col gap-2 w-full">
                        <div class="w-full sm:w-1/2">
                            ...
                            <input type="text" name="title" id="title" class="mt-1 block w-full form-input text-gray-700 dark:text-gray-300 dark:bg-gray-700 rounded-md border-gray-300 dark:border-gray-600 focus:border-purple-500 focus:ring focus:ring-purple-200" value="<?php echo e(old('title', $field->title)); ?>" placeholder="Enter field title">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="w-full sm:w-1/3">
                            ...
                            <input type="number" name="amount" id="amount" class="mt-1 block w-full form-input text-gray-700 dark:text-gray-300 dark:bg-gray-700 rounded-md border-gray-300 dark:border-gray-600 focus:border-purple-500 focus:ring focus:ring-purple-200" value="<?php echo e(old('amount', $field->amount)); ?>" placeholder="Enter amount">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex flex-col w-full">
                        ...
                        <div class="w-full">
                            ...
                            <span>
                                <small class="text-gray-500 dark:text-gray-400">If you don't select a new image, the existing image will remain unchanged.</small>
                            </span>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ftpuser/resources/views/admin/payments/edit.blade.php ENDPATH**/ ?>