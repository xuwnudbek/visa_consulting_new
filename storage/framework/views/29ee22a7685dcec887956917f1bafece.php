        ...
        <div class="container my-6 px-6 mx-auto grid">
            ...
            <form action="#" class="flex flex-col bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md space-y-6">
                <div class="flex flex-col sm:flex-row gap-6">
                    <div class="flex flex-col w-full gap-4">
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text" disabled class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700
                                   ...
                                   dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value="<?php echo e($application->user->name); ?>">
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text" disabled class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700
                                   focus:border-purple-400 focus:outline-none focus:shadow-outline-purple
                                   dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value="<?php echo e($application->user->email); ?>">
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text" disabled class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700
                                   focus:border-purple-400 focus:outline-none focus:shadow-outline-purple
                                   dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value="<?php echo e($application->user->phone ?? '-'); ?>">
                        </label>
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text" disabled class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700
                                   focus:border-purple-400 focus:outline-none focus:shadow-outline-purple
                                   dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value="<?php echo e($application->country->name); ?>">
                        </label>
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text" disabled class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700
                                   focus:border-purple-400 focus:outline-none focus:shadow-outline-purple
                                   dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value="<?php echo e($application->field->title); ?>">
                        </label>
                    </div>
                    ...
                    <div class="flex flex-col w-full gap-4">
                        ...
                        <label class="block text-sm">
                            ...
                            <input disabled value="<?php echo e(number_format(old('amount', $application->amount))); ?> sum" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700
                                   focus:border-purple-400 focus:outline-none focus:shadow-outline-purple
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text" disabled class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700
                                   focus:border-purple-400 focus:outline-none focus:shadow-outline-purple
                                   dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value="<?php echo e(ucfirst($application->status)); ?>">
                        </label>
                        ...
                        <label class="block text-sm">
                            ...
                            <textarea type="text" rows="4" disabled class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700
                                   focus:border-purple-400 focus:outline-none focus:shadow-outline-purple
                                   dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Enter comment"><?php echo e($application->comment ?? 'No comment provided'); ?></textarea>
                        </label>
                        
                        <?php if($application->document): ?>
                            <label class="block text-sm">
                                <span class="text-gray-700 dark:text-gray-400">Document</span>
                                <a href="<?php echo e(asset('storage/' . $application->document)); ?>" target="_blank" class="text-purple-600 hover:underline">
                                    View Document
                                </a>
                            </label>
                        <?php endif; ?>
                ...
                <div class="flex justify-end space-x-4 items-center">
                    ...
                    <a href="<?php echo e(route('admin.payments.show', $application->id)); ?>" class="px-4 py-2 text-sm font-medium text-white bg-purple-600 rounded-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2">
                        Payments
                    </a>
                </div>
            </form>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ftpuser/resources/views/admin/applications/show.blade.php ENDPATH**/ ?>