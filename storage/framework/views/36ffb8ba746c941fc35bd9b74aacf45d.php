...
<?php $__env->startSection('content'); ?>
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container my-6 px-6 mx-auto grid">
            ...
            <form action="<?php echo e(route('admin.countries.store')); ?>" method="POST" class="w-full bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="flex flex-col items-center justify-center gap-4 md:flex-row md:space-x-2 mb-4">
                    <div class="w-full md:w-1/2">
                        ...
                        <input type="text" name="name" id="name" class="mt-1 block w-full form-input text-gray-700 dark:text-gray-300 dark:bg-gray-700 rounded-md border-gray-300 dark:border-gray-600 focus:border-purple-500 focus:ring focus:ring-purple-200" value="<?php echo e(old('name')); ?>" placeholder="Enter country name">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ftpuser/resources/views/admin/countries/create.blade.php ENDPATH**/ ?>