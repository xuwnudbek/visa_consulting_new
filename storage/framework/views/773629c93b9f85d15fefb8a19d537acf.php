...
<?php $__env->startSection('content'); ?>
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container my-6 px-6 mx-auto grid">
            ...
            <form action="<?php echo e(route('admin.clients.store')); ?>" method="POST" class="flex flex-col bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="flex gap-4 flex-col md:flex-row">
                    ...
                    <div class="flex flex-col w-full gap-4">
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text" name="name" required value="<?php echo e(old('name')); ?>" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="email" name="email" required value="<?php echo e(old('email')); ?>" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700
                              focus:border-purple-400 focus:outline-none focus:shadow-outline-purple
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="tel" name="phone" value="<?php echo e(old('phone')); ?>" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700
                              focus:border-purple-400 focus:outline-none focus:shadow-outline-purple
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text" name="passport" value="<?php echo e(old('passport')); ?>" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700
                              focus:border-purple-400 focus:outline-none focus:shadow-outline-purple
                    ...
                    <div class="flex flex-col w-full gap-4">
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="date" name="birthday" value="<?php echo e(old('birthday')); ?>" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700
                              focus:border-purple-400 focus:outline-none focus:shadow-outline-purple
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ftpuser/resources/views/admin/clients/create.blade.php ENDPATH**/ ?>